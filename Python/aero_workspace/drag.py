...
# cruise
mu_10k = 1.458e-5 # [Ns/m^2] dynamic viscosity at 10000 ft
V_cruise = 93.63 # [m/s]
C_L_cruise = W / (1/2*rho_10k*V_cruise**2*S)


# takeoff
rho_sl = 1.225 # [kg/m^2]
mu_sl = 1.7894e-5 # [Ns/m^2] dynamic viscosity at sea level
V_takeoff = 17 # [m/s]
C_L_takeoff = 8 # from wt data???
