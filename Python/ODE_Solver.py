...
class Aircraft:
    def __init__(self, m_total, I_y, rho, S, St, R, omega, CL0, CLa,CLq, CL_de, CL_df, cx, cx_prime, Cm0, Cma, Cmq, Cm_de, Cm_df, cd_profile, cd_w, cd_t, CT, static_condition, alpha_0, h, b, c_bar, initial_conditions):
        self.m=m_total
        self.I_y=I_y
        self.S=S
        self.St=St
    ...
    def CL(self, t, x):
        ...
        return self.CL0+self.CLa*del_alpha+self.CLq*del_qbar+self.CL_df*del_f+self.CL_de*del_e
    ...
    def Cm(self, t, x):
        ...
        return self.Cm0+self.Cma*del_alpha+self.Cmq*del_qbar+self.Cm_df*del_f+self.Cm_de*del_e
    def CD(self, t, x):
        return self.cd_profile/self.S+self.cd_w+self.cd_t*self.St/self.S+self.CL(t, x)**2/(np.pi*self.AR)
