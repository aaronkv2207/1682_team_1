...
class Aircraft:
    ...
    def takeoff_event(self, t, x):
        ...
        rho=Atmosphere(h=ze*-1).density[0]
        Q = 0.5 * rho * V**2
        CL, Cm, CD= self.aero_coefficents(x, self.controls(t, x))
...
z_e0 = 0  # initial altitude above runwayin meters
