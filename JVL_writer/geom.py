...
Vv = 0.08  # Vertical tail volume coefficient
vt_ar = 1.2
tail_hinge = 0.7
...
wingA = JWing(
    ...
    xsecs=[
        WingJSec(
            ...
            airfoil=main_foil,
            control_surfaces=[
                asb.ControlSurface(name="Flap1", hinge_point=flap_hinge, deflection=0)
            ],
        ...
        WingJSec(
            ...
            control_surfaces=[
                asb.ControlSurface(name="Flap1", hinge_point=flap_hinge, deflection=0),
                asb.ControlSurface(name="Flap2", hinge_point=flap_hinge, deflection=0),
            ],
            JetControls=[
        ...
        WingJSec(
            ...
            control_surfaces=[
                asb.ControlSurface(name="Flap2", hinge_point=flap_hinge, deflection=0),
                asb.ControlSurface(
                    name="Aileron", symmetric=False, hinge_point=ail_hinge, deflection=0
                ),
                asb.ControlSurface(
                    name="Flaperon", symmetric=True, hinge_point=ail_hinge, deflection=0
                ),
            ],
...
wingB = JWing(
    ...
    xsecs=[
        ...
        WingJSec(
            ...
            airfoil=main_foil,
            control_surfaces=[
                asb.ControlSurface(name="Flap2", hinge_point=0.8, deflection=0),
                asb.ControlSurface(
                    name="Aileron", symmetric=False, hinge_point=ail_hinge, deflection=0
                ),
                asb.ControlSurface(
        ...
        WingJSec(
            ...
            control_surfaces=[
                ...
                asb.ControlSurface(
                    name="Flaperon", symmetric=True, hinge_point=0.8, deflection=0
                ),
            ],
        ),
    ],
...
vertical_tail = asb.Wing(
    ...
    xsecs=[
        WingJSec(
            ...
            control_surfaces=[
                asb.ControlSurface(name="Rudder", hinge_point=tail_hinge, deflection=0)
            ],
        ),
        WingJSec(
...
horizinatal_tail = asb.Wing(
    ...
    xsecs=[
        WingJSec(
            ...
            control_surfaces=[
                asb.ControlSurface(
                    name="Elevator", hinge_point=tail_hinge, deflection=0
                )
            ],
        ),
        WingJSec(
...
def generate_fuselage_xsecs(N: int) -> List[asb.FuselageXSec]:
    ...
    z = -r / 2
    zs = np.interp(
        x_positions, [nose_x, 7.8 * nose_x, nose_x / 2, 0, vt_x / 2, vt_x, fuse_end], z
...
jvl_planeA.default_analysis_specific_options = {
...
jvl_planeB.default_analysis_specific_options = {
    asb.Airplane: dict(profile_drag_coefficient=0),
    JWing: dict(
        wing_level_spanwise_spacing=True,
        spanwise_resolution=25,
